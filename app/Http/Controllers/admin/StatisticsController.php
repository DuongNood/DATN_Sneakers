...
class StatisticsController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        $bestSellingProducts = Product::select('product_name', DB::raw('SUM(order_details.quantity) as total_sold'))
        ...
        // Lấy danh sách top khách hàng theo tổng số tiền đã chi tiêu
