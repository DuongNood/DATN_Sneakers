...
const ForgotPassword = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Quên mật khẩu - Pole Sneakers</title>
        <meta name='description' content='quên mật khẩu Pole-Sneakers' />
        <meta property='og:description' content='Khôi phục mật khẩu tài khoản Pole Sneakers.' />
