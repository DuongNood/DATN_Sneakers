...
import '../assets/style/css/news.css' // Custom CSS file
              ...
              {currentArticles.map((article, index) => (
                <div key={index} className='col-md-4 mb-2'>
                  <div className='card news-card'>
                    <img src={article.img} className='card-img-top' alt='News' />
        ...
        <div className='pagination-container'>
          <ul className='pagination justify-content-end'>
            <li className={`page-item ${currentPage === 1 ? 'disabled' : ''}`}>
              <button className='page-link' onClick={() => goToPage(currentPage - 1)} aria-label='Previous page'>
                Trước
              </button>
            </li>
            ...
            <li className={`page-item ${currentPage === totalPages ? 'disabled' : ''}`}>
              <button className='page-link' onClick={() => goToPage(currentPage + 1)} aria-label='Next page'>
                Kế tiếp
              </button>
            </li>
          </ul>
